<!-- Hero -->
<div
    class="overflow-hidden relative bg-gradient-to-bl from-blue-100 via-transparent dark:from-blue-950 dark:via-transparent">
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <!-- Grid -->
        <div class="grid  items-center md:grid-cols-2 gap-8 lg:gap-12">
            <div data-aos="fade-right" data-aos-easing="linear" data-aos-offset="500" data-aos-duration="700" class="h-full flex items-center">

                <div>
                    <!-- Title -->
                    <div class="mt-4 md:mb-12 max-w-2xl">
                        <h1 class="mb-4 font-bold text-gray-800 text-2xl lg:text-3xl dark:text-gray-200">
                            HUBUNGI KAMI
                        </h1>
                        <p class="text-gray-600 dark:text-gray-400">
                            Selamat datang di layanan dukungan kami! Kami sangat senang dapat membantu Anda. Jika Anda
                            memiliki pertanyaan, komentar, atau masukan, jangan ragu untuk menghubungi kami
                        </p>
                    </div>
                    <!-- End Title -->
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <img class="h-8 w-8 rounded-full"
                                        src="https://rigabusinessforum.com/wp-content/uploads/2019/06/SHARMA.jpg"
                                        alt="Image Description">
                                </div>
                                <div class="grow ms-4">
                                    <div class="font-semibold text-gray-800 dark:text-gray-200">Robin Sharma</div>
                                    <div class="text-xs text-gray-500"> is one of world's top leadership experts.</div>
                                </div>
                            </div>
                        </footer>
                    </blockquote>
            ...
            <div data-aos="fade-left" data-aos-easing="linear" data-aos-offset="500" data-aos-duration="700">
                <!-- Form -->
                <form>
                    <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                        ...
                        <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-slate-900">
                            <div class="text-center">
                                <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Masukan Pesan</h1>
                                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                    Kami akan senang mendengar apapun dari Anda dan siap membantu dengan pertanyaan atau
                                    permintaan apapun yang Anda miliki.
                                </p>
                            </div>
                        ...
                        autofill:pb-2"
                          ...
                          peer-[:not(:placeholder-shown)]:text-xs
                          peer-[:not(:placeholder-shown)]:-translate-y-1.5
                          peer-[:not(:placeholder-shown)]:text-gray-500">Nomer
                                                Telepon</label>
                                        </div>
                                        <!-- End Floating Input -->
                                    </div>
                                    ...
                                    <div class="relative col-span-full">
                                        <!-- Floating Input -->
                                        <div class="relative">
                                            <input type="email" id="hs-hero-signup-form-floating-input-new-password"
                                                class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
                        focus:pt-6
                        focus:pb-2
                        [&:not(:placeholder-shown)]:pt-6
                        ...
                        autofill:pb-2"
                          ...
                          peer-[:not(:placeholder-shown)]:text-gray-500">Masukan
                                    ...
                                    <textarea id="message" rows="4"
                                        class="resize-none col-span-full block p-2.5 h-36 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"

    ...
    <div class=" flex flex-wrap items-center justify-between mx-auto md:mx-12 p-6">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                <li>
                    <a href="landingPage"
                        class="{{ request()->is('landingPage') || request()->is('landingPage/*') ? 'text-blue-700' : '' }} block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"

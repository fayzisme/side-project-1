                        ...
                        <div class="row">
                            <div class="col-lg-4 col-6">
                                ...
                                <div class="small-box bg-info">
                                    ...
                                    <a href="{{ route('gejala.index') }}" class="small-box-footer">More info <i
                            ...
                            <div class="col-lg-4 col-6">
                                ...
                                <div class="small-box bg-success">
                                    ...
                                    <a href="{{ route('penyakit.index') }}" class="small-box-footer">More info <i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-6">
                                ...
                                <div class="small-box bg-danger">
                                    ...
                                    <a href="{{ route('riwayat.index') }}" class="small-box-footer">More info <i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <!-- ./col -->
